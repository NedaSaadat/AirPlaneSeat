    ...
    <Row className="vh-100 justify-content-md-center">
      <Col md={4} >
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <button className="button2 button3" type="submit">Login</button>
        </Form>
      </Col>
    </Row>
...
function LogoutButton(props) {
  return (
    <button className="button2 button3"  variant='outline-light' onClick={props.logout}>Logout</button>
  )
}
function LoginButton(props) {
  const navigate = useNavigate();
  return (
    <button  className="button2 button3"  variant="outline-light" onClick={() => navigate('/login')}>Login</button>
  )
}
